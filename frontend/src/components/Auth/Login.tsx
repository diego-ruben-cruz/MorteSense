    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                window.location.href = "/"; // Redirect to desired page
            }
        } catch (error: any) {
            console.log(error);
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm"> <span
                                className="bg-white px-2 text-gray-500">Don't have an account ?
                                    <Link to="/registration"
                                          className="font-medium text-indigo-600 hover:text-indigo-500 ml-1">Sign Up</Link></span>
                            </div>
                        </div>
                    </div>
                </div>
