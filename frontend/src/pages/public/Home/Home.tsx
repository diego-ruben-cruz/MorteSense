    ...
    return (
        <>
            <div className="flex justify-center text-center flex-col py-10  items-center">
                <div className="py-10 bg-gray-50 content-width mx-5 rounded-lg xs:px-96 lg:px-0 ">
                    <div className="py-5 text-3xl md:text-6xl text-rose-900 font-bold">
                ...
                <div className="flex justify-center content-width items-center flex-col py-10">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                        <div className="p-10 xs:mx-96 lg:mx-0 bg-gray-50  rounded-lg">
                            <h2 className="text-xl md:text-2xl font-bold text-center text-rose-900">Real-time Monitoring</h2>
                            <p className="mt-4">
                        ...
                        <div className="p-10 xs:mx-96 lg:mx-0 bg-gray-50 rounded-lg">
                            <h2 className="text-xl md:text-2xl font-bold text-center text-rose-900">Advanced Analytics</h2>
                            <p className="mt-4">
                        ...
                        <div className="p-10 xs:mx-96 lg:mx-0 bg-gray-50 rounded-lg">
                            <h2 className="text-xl md:text-2xl font-bold text-center text-rose-900">Easy Integration</h2>
                            <p className="mt-4">
